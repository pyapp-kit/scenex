...
class AdaptorRegistry:
    ...
    # fmt: off
    @overload
    def get_adaptor(self, obj: model.Points,create: bool = ...) -> base.PointsAdaptor: ...  # noqa: E501
    @overload
    def get_adaptor(self, obj: model.Image,create: bool = ...) -> base.ImageAdaptor: ...
    @overload
    def get_adaptor(self, obj: model.Camera,create: bool = ...) -> base.CameraAdaptor: ...  # noqa: E501
    @overload
    def get_adaptor(self, obj: model.Scene,create: bool = ...) -> base.NodeAdaptor: ...
    @overload
    def get_adaptor(self, obj: model.View,create: bool = ...) -> base.ViewAdaptor: ...
    @overload
    def get_adaptor(self, obj: model.Canvas,create: bool = ...) -> base.CanvasAdaptor: ...  # noqa: E501
    @overload
    def get_adaptor(self, obj: model.EventedBase,create: bool = ...) -> base.Adaptor: ...  # noqa: E501
    # fmt: on
